...
while True:
    ...
    for (box, pred) in zip(locs, preds):
        ...
        cv2.rectangle(frame, (Xi, Yi-40), (Xf, Yi), (0,255,0), -1)
        cv2.putText(frame, label, (Xi+5, Yi-15),cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255), 2) # Texto en blanco
        cv2.rectangle(frame, (Xi, Yi), (Xf, Yf), (0,255,0), 3)

        # Dibujar una línea alrededor del rostro detectado
        cv2.line(frame, (Xi, Yi), (Xi+100, Yi), (0, 255, 0), 2)
        cv2.line(frame, (Xi+100, Yi), (Xi+100, Yi+100), (0, 255, 0), 2)
        cv2.line(frame, (Xi, Yi), (Xi, Yi+100), (0, 255, 0), 2)
        cv2.line(frame, (Xi, Yi+100), (Xi+100, Yi+100), (0, 255, 0), 2)
    ...
    cv2.putText(frame, str(int(fps))+" FPS", (5, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3, cv2.LINE_AA) # Texto de FPS en blanco
